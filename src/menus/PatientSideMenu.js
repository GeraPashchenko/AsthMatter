    ...
    return (
        <div className="sideMenu sideMenu1">
            ...
            <div id="sideMenu" className="flexDiv">
                <NavLink to="/attacksDiary" className="links attacksDiary" activeClassName="current">{localization.sideMenuPatient.attacksDiary[language]}</NavLink>
                ...
                <NavLink to="/inhaler" className="links inhaler" activeClassName="current">{localization.sideMenuPatient.inhaler[language]}</NavLink>
                ...
                <NavLink to="/" className="links logout" activeClassName="current" onClick={() => { logoutUser() }}>{localization.logoutLink[language]}</NavLink>
            </div>
        </div>
    )
}
